            ...
            <tbody>
              <tr>
                <td class="noBorder" width="40%">
                    <img width="360" height="240" src="{{ base_path }}/images/MMM.png" alt="MMM" style="border:0px">
                </td>
                <td>
              ...
              <tr>
                <td class="noBorder" width="40%">
                    <img width="360" height="240" src="{{ base_path }}/images/CLIP2FL.png" alt="CLIP2FL" style="border:0px">
                </td>
                <td>
              ...
              <tr>
                <td class="noBorder" width="40%">
                    <img width="360" height="240" src="{{ base_path }}/images/DPIS.png" alt="CLIP2FL" style="border:0px">
                </td>
                <td>
